...
NUMBERS = (
    ...
    GoodweNumberEntityDescription(
        ...
        native_min_value=0,
        native_max_value=99,
        getter=lambda inv: inv.get_offgrid_battery_dod(),
        mapper=lambda v: v,
        setter=lambda inv, val: inv.set_offgrid_battery_dod(val),
        filter=lambda inv: True,
    ),
    GoodweNumberEntityDescription(
        key="battery_soc_max",
        ...
        native_min_value=0,
        native_max_value=99,
        getter=lambda inv: inv.read_setting("battery_soc_max"),
        mapper=lambda v: v,
        setter=lambda inv, val: inv.write_setting("battery_soc_max"),
        filter=lambda inv: True,
    ),
    GoodweNumberEntityDescription(
        key="eco_mode_power",
